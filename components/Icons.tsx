...
export function PlaneIcon({ className = "w-5 h-5" }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.8} strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
      <path d="M17.8 19.2 16 11l3.5-3.5C21 6 21.5 4 21 3c-1-.5-3 0-4.5 1.5L13 8 4.8 6.2c-.5-.1-.9.2-1.1.7l-1 2.5c-.2.5.1 1 .6 1.1l7.5 2.2-2.8 2.8-3.2-.8c-.4-.1-.8.2-1 .6L2.6 17c-.2.4 0 .9.4 1.1L8 19.5l1.4 5c.2.4.7.6 1.1.4l1.7-1.2c.4-.2.7-.6.6-1l-.8-3.2 2.8-2.8 2.2 7.5c.1.5.6.8 1.1.6l2.5-1c.5-.2.8-.6.7-1.1Z" />
    </svg>
  );
}
...
export function FileCheckIcon({ className = "w-5 h-5" }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.8} strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
